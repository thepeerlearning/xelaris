  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-[64px] flex flex-col gap-8 md:gap-12">
      ...
      <div className="w-full flex flex-col gap-1 py-4">
        ...
        <h4 className="font-inter font-normal text-[28px]/[36px] sm:text-[32px]/[42px] md:text-[36px]/[48px] -tracking-[2.2%] text-[#252C32]">
          Alexa Perplex
        </h4>
        <p className="font-inter font-normal text-[14px]/[20px] sm:text-[15px]/[24px] -tracking-[0.6%] text-[#252C32]">
              ...
              <button
                ...
                className={`font-inter font-normal text-[14px]/[24px] -tracking-[0.6%] pb-2 transition-colors ${
                  activeTab === index + 1
                    ...
                    : "text-[#252C32] hover:text-primary/80"
                }`}
