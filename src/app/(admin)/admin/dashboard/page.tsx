...
export default function MyDashboardPage() {
  ...
  return (
    <div className="w-full flex flex-col gap-8 bg-[#FBF8E6]">
      ...
      <div className="w-full px-6 bg-[#FBF8E6]">
        <h4 className="w-full flex gap-2 font-bold font-inter text-lg text-secondary">
          All Students{" "}
          <span className="w-[25px] h-[25px] flex justify-center items-center p-[2px] mt-1 rounded-md border border-solid border-[#EAECF0] font-normal font-inter text-xs/[18px] ">
            {count ? count : 0}
          </span>
        </h4>
      </div>
      <div className="w-full bg-[#FBF8E6] flex flex-col p-2 lg:p-[12px_0_48px_0] rounded-xl border border-solid border-[#EAECF0] shadow-[0px_1px_2px_0px_rgba(16, 24, 40, 0.05)] relative">
        <div className="w-full flex flex-col md:flex-row gap-2 md:gap-8 xl:gap-12 xxl:gap-32 p-4">
          <Card className="w-full shadow-none border-[#E5E9EB] bg-transparent px-4 flex flex-col gap-10">
                ...
                <>
                            ...
                            <div
                              ...
                              className={`${
                                contact?.id === student.id
                                  ...
                                  : "bg-transparent"
                              } flex items-center space-x-4 rounded border border-[#E5E9EB] p-4`}
                            >
                              ...
                              <div className="flex-1 space-y-1">
                                <p
                                  className={
                                    contact?.id === student.id
                                      ? "text-black font-medium font-inter text-sm capitalize"
                                ...
                                <p
                                  className={
                                    contact?.id === student.id
                                      ? "text-black font-normal font-inter text-sm capitalize"
                                      : "text-secondary font-normal font-inter text-sm capitalize"
                                  }
                                >
                              ...
                              <Button
                                ...
                                className={
                                  contact?.id === student.id
                                    ? "w-[100px] mt-2 mr-1 bg-primary h-[40px] flex justify-center items-center py-[2px] px-[6px] border border-solid border-primary hover:text-white text-white font-inter font-medium text-xs/[18px] cursor-pointer rounded-full"
                                    : "w-[100px] bg-transparent h-[40px] flex justify-center items-center py-[2px] px-[6px] border border-solid border-primary text-primary font-inter font-medium text-xs/[18px] cursor-pointer rounded-full hover:bg-primary/10"
                                }
                              >
                                View class
                              </Button>
                  ...
                  <div className="w-full flex flex-col justify-center items-center py-[20px]] mt-8 md:mt-6 xl:mt-8">
                    <div className="flex justify-end items-center gap-4">
                      <Button
                        type="button"
                        className="w-[100px] h-[36px] py-4 px-[19px] normal-case font-bold font-ariaBoldl text-[14px]/[20.3px] text-[#344054] bg-white hover:bg-white/90 rounded-lg border border-solid border-[#D0D5DD] shadow-[0px_1px_2px_0px_#1018280D] disabled:cursor-not-allowed"
                      ...
                      <Button
                        type="button"
                        className="w-[104px] h-[36px] py-4 px-[19px] normal-case font-normal font-inter text-[14px]/[20.3px] text-white bg-primary hover:bg-primary/90 rounded-lg disabled:cursor-not-allowed disabled:bg-primary/50"
          ...
          {contact && (
            <div className="w-full flex flex-col gap-4">
              <div className="w-full bg-[#FBF8E6]">
                <div className="w-full h-[188px] p-6 flex flex-col flex-start gap-2 bg-[#FBF8E6] rounded-xl">
                  <h4 className="w-full flex text-[#000000] font-bold font-inter text-lg m-0 p-0">
                    Parent information
                  </h4>
                  <p className="w-full flex p-0 m-0 taxt-[#000000] gap-1 font-normal font-inter text-[16px]/[20px]">
                    Full name:{" "}
                    <span className="text-[#475467] font-normal font-inter text-sm">
                      {contact?.parent?.name}
                    </span>
                  </p>
                  <p className="w-full flex p-0 m-0 taxt-[#000000] gap-1 font-normal font-inter text-[16px]/[20px]">
              ...
              <div className="w-full flex flex-col gap-1 bg-[#FBF8E6] p-6 rounded-xl min-h-[123px]">
                <h4 className="w-full flex text-[#000000] font-medium font-inter text-lg m-0 p-0">
                  Class Schedule
                </h4>
                {!isEmpty(contact?.class?.schedules) ? (
                  contact?.class?.schedules.map((clx: any, index: number) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="w-full h-[210px] py-2 flex flex-col flex-start gap-2 bg-[#FBF8E6] rounded-xl"
                      >
                        <p className="w-full flex p-0 m-0 taxt-[#000000] gap-1 font-normal font-inter text-[16px]/[20px] capitalize">
                          Day:{" "}
                          <span className="text-[#475467] font-normal font-inter text-sm">
                            {clx.day}
                          </span>
                        ...
                        <div className="w-full flex justify-end items-center">
                          <Link
                            ...
                            target="_blank"
                            className="w-fit h-[36px] py-4 px-[22px] normal-case font-normal font-inter text-[14px]/[20.3px] text-white bg-primary hover:bg-primary/90 hover:scale-[1.008] transition duration-300 ease-in-out rounded-lg flex justify-center items-center"
                          >
                            Join Class
                          </Link>
                        </div>
              ...
              <div className="w-full flex flex-col gap-1 bg-[#FBF8E6] pt-6 pb-0 px-6 rounded-xl">
