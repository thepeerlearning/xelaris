  ...
  return (
    <div className="w-full flex flex-col relative min-h-screen overflow-hidden gap-6">
      <div className="w-full md:w-[426px] flex flex-col gap-6">
        <h1 className="text-[#000000] font-arial font-bold text-[24px]/[32px] md:text-[26px]/[38px] text-left">
          Settings
          <span className="block text-[#667185] font-arial font-normal text-[16px]/[24px] text-left">
