...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#FBF8E6]">
      <div className="lg-md:hidden">
        <header className="flex h-16 items-center border-b px-4 bg-[#FBF8E6]">
          <MobileNav />
          <h1 className="ml-2 text-xl font-semibold font-inter">
            Admin Portal
          </h1>
        </header>
        <main className="p-4 bg-[#FBF8E6]">{children}</main>
      </div>
...
function AppSidebar({ user }: any) {
  ...
  return (
    <Sidebar className="border-r border-[#e5e9eb] bg-[#FBF8E6]">
      <SidebarHeader className="flex items-center justify-center py-4 bg-[#FBF8E6]">
