...
export function StepIndicator({ currentStep, totalSteps }: StepIndicatorProps) {
  ...
  return (
    <div className="w-[160px] xl:w-[180px] flex items-center justify-center px-4 md:px-3">
        ...
        return (
          ...
          >
            <div className="flex items-center">
              {/* Step circle */}
              <div
                className={`flex w-5 h-5 xl:h-8 xl:w-8 items-center justify-center rounded-full  ${
                  isActive
                    ? "text-secondary"
                    : isCompleted
            ...
            {/* Step title */}
            <p
              className={`w-full font-inter font-medium tracking-normal text-xs xl:text-[13.67px]/[18px] text-black/83}`}
            >
              {stepTitles[index]}
            </p>
          </div>
