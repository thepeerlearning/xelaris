...
export default function SignUpBanner() {
  return (
    <div className="sticky -bottom-5 w-full z-10 bg-secondary hidden xl:flex flex-col xl:flex-row justify-center items-center py-[21px]">
      <div className="w-full 3xl:w-[1440px] px-[99px] flex 2xl:flex-col gap-[10px]">
