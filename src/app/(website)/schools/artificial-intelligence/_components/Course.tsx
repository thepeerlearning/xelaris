...
const modules = [
  ...
  "AI Tools & Frameworks (Python, TensorFlow, PyTorch)",
    ...
    >
      <div className="w-full flex flex-col gap-[30px] lg:gap-[58px]">
        ...
        <p className="w-full font-inter font-normal text-[#A2A2A2] text-[18px]/[27.6px] -tracking-[0.66px] flex flex-col gap-4">
          Artificial Intelligence is transforming nearly every aspect of modern
          life, turning what once seemed like science fiction into reality. From
          self-driving cars that navigate on their own to voice assistants like
          Alexa that answer questions and play music, AI is making everyday
          tasks easier and more efficient. It powers facial recognition on
          smartphones, recommends shows and videos on Netflix and YouTube, and
          even helps banks detect fraud.
          <span>
            Our School of AI offers hands-on, project-based courses where
            students learn to develop their own machine learning models and
            build a strong foundation in coding. Through real-world projects,
            they gain experience analyzing data, coding AI models, and solving
            complex problems—all under the guidance of experienced mentors.
          </span>
        </p>
        <div className="w-full flex flex-col xl:flex-row xl:h-[293.02px]">
          ...
          <div className="hidden xl:flex w-full xl:w-[439.53px] h-[293.02px] p-6 rounded-tr rounded-br bg-primary">
            <p className="w-full font-inter font-normal text-[18px]/[27px] text-[#FBF8E6] -tracking-[0.66px] align-middle">
              All our classes are flexible, personalized, and guided by
              experienced instructor. Your child will practice hands-on, build
              real-world projects, and receive 1-on-1 support all on a schedule
        ...
        <div className="w-ful xl:h-[386.63px] flex flex-col xl:flex-row">
          <div className="w-full xl:w-[248px] h-full p-6 rounded-tr rounded-br bg-primary">
            <p className="font-inter font-normal text-[18px]/[27px] text-[#FBF8E6] -tracking-[0.66px] align-middle">
              The program is taught by experienced mentors and graduate students
              specializing in AI. With their guidance, students gain hands-on
              experience in building AI models and solving complex problems,
              ensuring they develop a strong understanding of AI concepts
            </p>
          </div>
  ...
  const whyXelaris = (
    ...
    >
      <div className="w-full flex flex-col gap-[30px] lg:gap-[30px]">
        ...
        <p className="w-full font-inter font-normal text-[#A2A2A2] text-[18px]/[27.6px] -tracking-[0.66px] flex flex-col gap-4">
          This curriculum is carefully designed to give students a solid
          foundation in artificial intelligence while making learning both
          exciting and interactive. Through a structured, hands-on approach,
          students will build AI models, explore real-world applications, and
          deepen their understanding of AI step by step through our Capstone
          course.
        </p>
