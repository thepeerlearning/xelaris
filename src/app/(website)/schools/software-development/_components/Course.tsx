...
export default function CourseDescription() {
  ...
  const introduction = (
    <div
      id="introduction"
      className="w-full min-h-[828px] 2xl:rounded-[6px] py-[64px] px-5 lg:px-10 2xl:p-[64px] bg-secondary overflow-hidden"
    >
    ...
    >
      <div className="w-full flex flex-col gap-[30px] lg:gap-[30px]">
        ...
        <div className="w-full flex flex-col gap-[29px]">
          ...
          <div className="max-w-[666px] flex flex-wrap gap-4">
  ...
  return (
    <div className="w-full flex justify-center items-center relative pt-[64px] bg-[#FBF8E6]">
      <div className="max-w-[1297px] flex flex-col 2xl:flex-row gap-[30px] lg:gap-[58px] relative">
        {/* Menu */}
        ...
        <div className="w-full min-h-full max-w-[996px] px-0 2xl:pr-0 2xl:pl-10 ">
