...
export default function Footer() {
  ...
  return (
    <footer className="w-full min-h-[600px] flex flex-col bg-[#202426]">
      <div className="w-fullh-[108px] py-[22.78px] border-b-[0.2px] border-[#6C6A6B]  xl:px-5 2xl:px-0">
        <div className="w-full flex justify-center items-center">
          <div className="w-full  2xl:w-[1200px]  px-5 lg:px-6 xl:px-0">
            <WhiteAppLogo />
          </div>
        </div>
      </div>
      ...
      <div className="w-full flex justify-center items-center">
        <div className="w-full flex-col 2xl:w-[1200px] flex justify-center items-center">
          <div className="w-full flex flex-col justify-center items-center lg:px-8 xl:px-5 2xl:px-0">
            <div className="w-full max-w-[1440px] flex flex-col">
              <div className="w-full max-w-[1200px] min-h-[454px] grid grid-cols-1 xl:grid-cols-2">
                <div className="flex flex-col py-0 lg:py-[64px]">
                  <div className="w-[584.36px] hidden lg:flex gap-[64px] xl:gap-[25px] 2xl:gap-[64px]">
                    <div className="flex flex-col gap-[27px]">
                      ...
                      <div className="flex gap-1 items-center">
                        ...
                        <span className="w-[63px] h-[16px] flex justify-center items-center py-1 rounded bg-primary  font-inter font-medium text-white text-[7.6px] tracking-normal text-center uppercase ">
                          coming soon
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-[27px]">
                      ...
                      <Link
                        href="/schools/blockchain-technology"
                        className="font-inter font-light text-[#F7F7EE] text-sm/[25px] align-middle tracking-normal"
                      >
                ...
                <div className="h-full flex flex-col gap-[32px] py-[64px] px-6 xl:pl-[61px]  xl:border-l-[0.2px] xl:border-[#6C6A6B]">
                  <h4 className="font-inter font-normal text-[15px]/[15px] text-[#F7F7EE] tracking-normal align-middle">
                    About Xelaris
                  </h4>
                  <p className="font-inter font-light text-sm/[25px] text-[#F7F7EE] tracking-normal align-middle">
                    ...
                    harness the power of technology. Our mission is to educate
                    the next generation of innovators equipping them with the
                    skills to build, the curiosity to explore, and the
                    responsibility to apply their knowledge ethically to achieve
                    social good.
                  </p>
      ...
      <div className="h-[1px] border-t-[0.2px] border-[#6C6A6B] "></div>
    </footer>
  )
}
