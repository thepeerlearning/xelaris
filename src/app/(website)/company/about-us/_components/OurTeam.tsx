...
export default function OurTeam() {
  ...
  return (
    <div className="w-full bg-[#FBF8E6] pt-10 md:pt-16 lg:pt-20 xl:pt-[117px]">
      <div className="w-full max-w-[1302px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-[35px] 2xl:px-[38px] flex flex-col gap-8 md:gap-12 lg:gap-16">
        <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-6 md:gap-8 xl:gap-[120px]">
          ...
          <p className="font-inter font-normal text-secondary text-[14.13px]/[22.4px] md:text-[16px]/[24px] tracking-normal max-w-[625px]">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          {team.map((member, index) => {
            ...
            return (
              <div
                key={index}
                className={`relative flex xl:flex-col items-center xl:items-start justify-start gap-4 p-6 md:p-8
                  border-b border-secondary
                  ${isLastItem ? "border-b-0 md:border-b" : ""}
                  
                  md:border-r md:border-t md:border-l
              ...
              >
                <div className="w-16 h-16 mb-4 rounded-full overflow-hidden">
                  <Image
                    src={member.img || "/placeholder.svg?height=64&width=64"}
                    alt={`${member.name}`}
                    width={64}
                    height={64}
                ...
                <div className="flex flex-col">
                  <h4 className="text-secondary font-inter font-normal text-left text-[22px]/[28px] md:text-[26px]/[40px] 2xl:text-[29.63px]/[40px] tracking-normal">
                    {member.name}
                  </h4>
                  <p className="text-[#202426] font-inter font-normal text-left text-[12px]/[18px] md:text-[14.25px]/[20px] tracking-normal mt-1">
                    {member.role}
                  </p>
                </div>
              </div>
